...
/// RootDecider widget to determine root screen based on Firebase auth stream
/// Matches Agro-Prod/Wanderlust pattern while working seamlessly with standard views
      ...
      builder: (context, snap) {
        ...
        return FutureBuilder<DocumentSnapshot>(
          ...
          builder: (context, snap2) {
            ...
            FirebaseMessagingService.saveTokenToFirestore(isAdmin);
